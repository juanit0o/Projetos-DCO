...
public class Comerciante implements Observer {
	...
	public void update(Observable o, Object arg) {
		...
		if(o instanceof Venda && arg instanceof Compra) {
			Venda c = (Venda) o;
			Compra st = (Compra) arg;
			System.out.println("Reserva " + st.getId() + " recolhida com sucesso as " + LocalDateTime.now().format(DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm")));
			//POSSIBILIDADE DE IMPRIMIR A LISTA DOS PRODUTOS DA RESERVA
		}
